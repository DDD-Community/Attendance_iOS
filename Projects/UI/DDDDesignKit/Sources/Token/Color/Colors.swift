...
public extension Color {
  ...
  static let textCaption = Color(hex: "9B9B9B")
  ...
  static let borderNormal = Color(hex: "45464F")
  ...
  static let statusErrorText = Color(hex: "F54C42")

  // MARK: - 출결 칩 (출석/지각/결석)

  static let attendanceAttendedBg = Color(hex: "1A3824")
  static let attendanceAttendedText = Color(hex: "66C773")
  static let attendanceLateBg = Color(hex: "3D2E0F")
  static let attendanceLateText = Color(hex: "FF9E0A")
  static let attendanceAbsentBg = Color(hex: "3D1A1A")
  static let attendanceAbsentText = Color(hex: "FF453B")
  ...
  static let blue45 = Color(hex: "2E71FF")
