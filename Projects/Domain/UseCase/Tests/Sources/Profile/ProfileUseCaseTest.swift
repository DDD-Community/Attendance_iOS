...
struct ProfileUseCaseTest {
    ...
    func test_get_profile_success_manager() async throws {
    ...
    func test_get_profile_success_member() async throws {
        // Given: Member 프로필 설정
        let expectedProfile = ProfileEntity(
            userID: 456,
            name: "멤버 박영희",
    ...
    func test_get_profile_failure_network() async throws {
        // Given: 네트워크 오류 설정
    ...
    func test_edit_profile_success_promotion() async throws {
    ...
    func test_edit_profile_success_member_update() async throws {
    ...
    func test_edit_profile_failure_unauthorized() async throws {
        // Given: 권한 없음 에러 설정
        let userSession = UserSession(
            userID: 999,
            name: "권한없음",
    ...
    func test_authority_promotion_scenario() async throws {
        // Given: 권한 승급 시나리오
        // 1. 기존 Member 프로필 조회
    ...
    func test_team_change_scenario() async throws {
        // Given: 팀 변경 시나리오
        let userSession = UserSession(
            userID: 777,
            name: "팀변경자",
    ...
    func test_direct_edit_profile_input() async throws {
