...
struct ScheduleUseCaseTest {
    ...
    func test_get_schedule_success() async throws {
        // Given: 성공적인 일정 조회 설정
    ...
    func test_get_schedule_empty() async throws {
        // Given: 빈 일정 목록 설정
    ...
    func test_get_schedule_network_failure() async throws {
        // Given: 네트워크 오류 설정
    ...
    func test_get_schedule_unauthorized() async throws {
        // Given: 권한 없음 오류 설정
    ...
    func test_schedule_date_conversion() async throws {
    ...
    func test_schedule_id_validation() async throws {
    ...
    func test_schedule_description_handling() async throws {
        // Given: 다양한 설명을 가진 일정들
        let schedules = [
            Schedule(id: 1, name: "빈 설명", description: "", month: 1, day: 1, year: 2026),
            Schedule(id: 2, name: "긴 설명", description: "매우 긴 설명입니다. 이것은 일정에 대한 상세한 설명으로 여러 줄에 걸쳐 작성될 수 있습니다. 특수문자도 포함됩니다: !@#$%^&*()", month: 1, day: 1, year: 2026),
    ...
    func test_monthly_schedule_filtering_simulation() async throws {
        // Given: 다양한 월의 일정들
        let allSchedules = [
    ...
    func test_large_schedule_performance() async throws {
    ...
    func test_concurrent_schedule_requests() async throws {
