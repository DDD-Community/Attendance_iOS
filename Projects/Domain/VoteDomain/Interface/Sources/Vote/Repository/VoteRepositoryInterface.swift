...
public protocol VoteRepositoryInterface: Sendable {
...
public enum VoteRepositoryDependency: TestDependencyKey {
  ...
  public static var testValue: VoteRepositoryInterface {
    MockVoteRepository()
  }

  public static var previewValue: VoteRepositoryInterface = testValue
}

public extension DependencyValues {
  var voteRepository: VoteRepositoryInterface {
